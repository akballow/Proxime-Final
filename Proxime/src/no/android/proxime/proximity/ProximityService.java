...
import no.android.proxime.FeaturesActivity;
...
public class ProximityService extends BleProfileService implements ProximityManagerCallbacks {
	...
	public class ProximityBinder extends LocalBinder {
		...
		public void startImmediateWarning() {
			Logger.i(getLogSession(), "[Proximity] Immediate warning request: ON");
			mProximityManager.writeImmediateWarning();
		}
		...
		public void getRssi() {
			Logger.i(getLogSession(), "getting rssi");
			mProximityManager.getRssi();
		}
		
		public int getRssiValue() {
			Logger.i(getLogSession(), "getting rssi value");
			int temp = mProximityManager.rssilevel;
			return temp;
		}
		
		public void playAlarm() {
			Logger.i(getLogSession(), "getting alarm");
			mProximityManager.playAlarm();
		}
		
		public void stopAlarm() {
			Logger.i(getLogSession(), "stopping alarm");
			mProximityManager.stopAlarm();
		}
		
		public void playNotification() {
			Logger.i(getLogSession(), "getting notification");
			mProximityManager.playNotification();
		}
		
		public int checkDrop() {
			Logger.i(getLogSession(), "checking drop");
			int temp = mProximityManager.dropValue;
			return temp;
		}
		
		public void stopDrop() {
			Logger.i(getLogSession(), "stopping drop");
			mProximityManager.dropValue = 0;
